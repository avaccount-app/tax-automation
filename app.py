...
# 2. ดึง API Key จาก Secrets ความปลอดภัยหลังบ้าน
try:
...
# 3. จองพื้นที่จำสถานข้อมูล (Session State)
...
# 4. ฟังก์ชันจัดการความสะอาดข้อความส่งสรรพากร
...
# 5. ฟอร์มรับไฟล์ข้อมูลหน้าเว็บ
uploaded_files = st.file_uploader(
    "ลากไฟล์ PDF หรือรูปภาพใบหักภาษี ณ ที่จ่ายมาวางตรงนี้", 
    type=["pdf", "jpg", "jpeg"], 
...
if uploaded_files and api_key:
    if st.button("🚀 เริ่มประมวลผลความเร็วสูง", type="primary"):
        ...
        status_text.text("✨ จัดโครงสร้างส่งกรมสรรพากร...")
...
if st.session_state.pnd3_content or st.session_state.pnd53_content:
    st.success("🎉 ประมวลผลข้อมูลและจัดเรียงวันที่เสร็จสมบูรณ์!")
